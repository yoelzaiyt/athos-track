...
import { ShieldCheck, ArrowRight, Lock, Mail, Eye, EyeOff, Sparkles, Satellite } from 'lucide-react';
      ...
      >
        <div className="relative rounded-[28px] p-[2px] overflow-hidden shadow-2xl shadow-black/60">
          ...
          <div className="relative rounded-[26px] bg-slate-950/92 backdrop-blur-xl p-8">
            ...
            <div className="mb-6 p-3.5 bg-gradient-to-r from-amber-500/10 to-emerald-500/10 border border-amber-500/20 rounded-xl flex items-center justify-between">
              <div>
              ...
              <button
                ...
                className="px-3 py-1.5 bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-400 hover:to-orange-400 disabled:opacity-60 disabled:cursor-not-allowed text-slate-950 text-xs font-bold rounded-lg shadow-md shadow-amber-500/30 transition-all hover:scale-105 active:scale-95 shrink-0"
              >
                Acessar
              </button>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="relative">
                ...
                <input
                  ...
                  placeholder=" "
                  className="peer w-full bg-slate-900/70 border border-slate-800 rounded-xl pl-10 pr-4 pt-5 pb-2 text-sm text-slate-200 focus:outline-none focus:border-cyan-500/70 focus:ring-4 focus:ring-cyan-500/10 transition-all"
                />
                <label
                  htmlFor="login-email"
                  className="absolute left-10 top-1/2 -translate-y-1/2 text-slate-500 text-sm transition-all pointer-events-none peer-focus:top-3.5 peer-focus:text-[10px] peer-focus:font-semibold peer-focus:text-cyan-400 peer-focus:-translate-y-0 peer-[:not(:placeholder-shown)]:top-3.5 peer-[:not(:placeholder-shown)]:text-[10px] peer-[:not(:placeholder-shown)]:-translate-y-0 uppercase tracking-wider"
                >
                  E-mail de Acesso
                </label>
              </div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder=" "
                  className="peer w-full bg-slate-900/70 border border-slate-800 rounded-xl pl-10 pr-10 pt-5 pb-2 text-sm text-slate-200 focus:outline-none focus:border-violet-500/70 focus:ring-4 focus:ring-violet-500/10 transition-all"
                />
                <label
                  htmlFor="login-password"
                  className="absolute left-10 top-1/2 -translate-y-1/2 text-slate-500 text-sm transition-all pointer-events-none peer-focus:top-3.5 peer-focus:text-[10px] peer-focus:font-semibold peer-focus:text-violet-400 peer-focus:-translate-y-0 peer-[:not(:placeholder-shown)]:top-3.5 peer-[:not(:placeholder-shown)]:text-[10px] peer-[:not(:placeholder-shown)]:-translate-y-0 uppercase tracking-wider"
                >
                  Senha
                </label>
                <button
